...
export const metadata = {
  title: "Perfil — Leilão da Receita",
};

/**
 * Placeholder page for the "perfil" route. The leilão feature scaffolded this
 * route empty; this stub provides a valid default export so the production
 * build succeeds. Replace with the real profile screen.
 */
export default function LeilaoPerfil() {
  return (
