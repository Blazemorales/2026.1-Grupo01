# Vídeos para a validação dos cenários e storyboards

## Tabela de contribuição

| Membro | Contribuição | Data |
| :--- | :--- | :--- |
...
- Artefatos validados:
    ...
    - [análise de tarefas 4](../tarefas/tarefas_entrevista.md#22-analise-hta-emissao-de-certidao-negativa-de-debitos-cnd)
    - [análise de tarefas 5](../tarefas/tarefas_entrevista.md#23-analise-hta-cadastro-na-caixa-postal-da-receita-federal)
...
- Usuário : Marcio Junio
- Artefatos valiados: 
    - [storyboard 4](../storyboards/storyboard.md#14-storyboard-4)
    - [storyboard 5](../storyboards/storyboard.md#15-storyboard-5)
    - [análise de tarefas 6](../tarefas/tarefas_entrevista.md#24-analise-hta-busca-de-informacoes-do-cpf)
