...
O objetivo principal é estruturar os dados coletados durante a etapa de storyboards realizados pelos membros do grupo. A partir deste planejamento, será produzido o relato de resultados que destacará pontos de melhoria para o sistema, além de sugestões de aprimoramento.
...
| [Thiago Gomes](https://github.com/thgomxs)      | [Definição dos métodos de avaliação](#3-definicao-dos-metodos-de-avaliacao)       | 19/05/2026 |
...
|   Critério   | Descrição                                                                   |
| :----------: | :-------------------------------------------------------------------------- |
|  Frequência  | Com que frequência o problema ocorreu entre os participantes                |
|   Impacto    | Qual o efeito do problema na realização da tarefa pelo usuário              |
...
- A descrição do contexto e do método utilizado;
- Um sumário dos dados coletados;
- A lista de problemas encontrados, organizados por criticidade;
...
| 1.6    | 19/05/2026 | adições ao documento (métodos)                     | [Thiago Gomes](https://github.com/thgomxs)      |
