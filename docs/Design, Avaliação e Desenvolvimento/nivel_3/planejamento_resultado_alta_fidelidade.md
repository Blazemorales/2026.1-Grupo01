...
O planejamento do resultados do protótipo de alta fidelidade tem como objetivo organizar como os dados obtidos atraves da validação de usuários afetaram o projeto, como os dados seram estudados, quais seram as decisões tomadas após a análise dos dados.
...
Para essa étapa foram separadados alguns topicos importantes:
 ...
 - **Alocação de pessoas**: Todos os integrantes do grupo faram essa étapa
 - **Treinamento dos avaliadores**: Não será necessário, já que os avaliadores tem o conhecimento prévio da matéria e ja sabem oque precisam fazer nessa étapa.
 - **Equipamento e recursos**: Para esse avaliação seram precisos: Computadores com acesso a internet para que possam colocar suas análises sobre os dados encontrados
 - **Ambiente**: Cada integrante fará essa étapa em sua própia casa, mas sempre se comunicando via whatsapp e fazendo reuniões no discord se necessários.

 - **Prazos e orçamentos**: Essa etápa desse ser entregada até 3 horas antes da reunião para a gravação da étapa (14/06/2026) para que o grupo possa revisar o trabalho e fazer as devidas modificações. A avaliação não envolverá custos financeiros (orçamento zero), já que os materiais eletrônicos serão de propriedade dos avaliadores, como computadores.
