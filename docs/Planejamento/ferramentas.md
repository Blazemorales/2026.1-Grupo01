...
<p>Tabela 1: Ferramentas de uso contínuo</p>
...
| ![logo google docs](../images/planejamento/ferramentas/google-docs-icon.png) {: style="height: 10px; width: 10px"}     | Google Docs     | Editor online de texto em grupo.                                                                               |
| ![logo google sheets](../images/planejamento/ferramentas/google-sheets-icon.png) {: style="height: 10px; width: 10px"} | Google Sheets   | Editor online de planilhas em grupo.                                                                           |
...
| ![logo mermaid](../images/planejamento/ferramentas/mermaid-icon.svg) {: style="height: 10px; width: 10px"}       | Mermaid | Plataforma de criação de diagramas.                                                                            |
...
| ![logo obs](../images/planejamento/ferramentas/obs-icon.png) {: style="height: 10px; width: 10px"}                     | OBS             | Software para gravação das reuniões e apresentações.                                                           |
...
<p>Tabela 2: Ferramentas utilizadas em entregas específicas</p>
