...
A forma com que nós, do grupo 01, lidamos com os **aspectos éticos** foi feito seguindo as orientações e modelos mostrados no capítulo 5 do livro de BARBOSA (2021)

---

## **Termo de Consentimento Livre e Esclarecido**
O modelo que foi disponbilizado aos participantes das nossa técnicas para perfil de usuário (brainstorming, entrevistas, e análise de documentos) seguiram o modelo, baseado em BARBOSA (2021): 
...
> - Nossa equipe encontra-se disponível para contato através do e-mail `<email-da-equipe>`.
>
...
> Brasília, 30/04/2026
>
> `<Assinatura do membro do grupo 01>` `<Assinatura do Entrevistado>`
> `<Nome do membro do grupo 01>` `<Nome do Entrevistado>`
...
|-----|--------------------|-------|
|[João Morais](https://github.com/Blazemorales)| Criou a página de aspectos éticos | 01/05/2026|

## **Versionamento**
| Versão | Data | Descrição | Autor(es/as) | Revisor(es/as) |
|--------|------|-----------|--------------|----------------|
| 1.0 | 01/05/2024 | Reunião de Brainstorming | [João Morais](https://github.com/Blazemorales) | |
