...
Baseado nas tecnicas utilizadas pelos estudantes, após analisar todas as caracteristicas encontradas pelo grupo foi possivel notar um padrão em comum em todas as análises, na qual é possivel traçar um perfil de usuário geral baseado no que o grupo encontrou.

## Tabela de contribuição 

| Autor | Análises realizadas | Data |
| :--- | :--- | :--- |
| [Heyttor Augusto](https://github.com/H3ytt0r62) | Análise do perfil do usuário por meio da [entrevista](../Entrevista/Entrevista_Heyttor.md) e análise do antiusário por meio da [análise de documetos](../analise_de_documentos/analise_documentos_heyttor)| 02/05/2026 |
...
- **idade**: 20 a 65 anos
- **gênero**: Sem um gênero predominante  
- **necessidades**: Fazer diversas consultas pessoais sobre seus dados como CPF ou CNPJ 
- **Objetivos**: Patricidade e eficiência 
- **conhecimento sobre tecnologias**: Tem algumas dificuldades com a navegação no sistema

## Usuário secundário - Empresário

- **Idade**: 18 a 60
- **Necessidades**: Acesso frequente a serviços fiscais, Emissão de certidões e regularização de débitos, Envio de declarações obrigatórias
- **Objetivos**: Cumprir obrigações fiscais dentro dos prazos, Manter a empresa regularizada, Evitar multas e sanções
- **Conhecimento sobre tecnologia**: MEIs: básico a intermediário, com possíveis dificuldades de navegação

## usuário terceario - Cidadãos regulares que precisam obter dados como certidão de CPF

- **idade**: 16 a 60 anos
- **Gênero**: Todos os gêneros
- **Necessidades**: Obter dados cadastrais básicos, Acessar documentos oficiais de forma rápida
...
| :--- | :--- | :--- | :--- | :--- |
| 1.0 | 03/05/2026 | Criação do documento | [Heyttor augusto](https://github.com/H3ytt0r62) | - |